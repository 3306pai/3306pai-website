...
export default function Company() {
  return (
    <Layout
      ...
      description="我们也在全国招募志愿者： 地区负责人， 技术 writer, 如果你也想参与到 3306π 活动中，请联系我们。">
        ...
        <div className={styles.banner}>
          ...
          <div className={`${styles.bannerContaniner} global-container-width`}>
            <div className={styles.text}>
              ...
              <p className={styles.description}>我们也在全国招募志愿者： 地区负责人，技术 writer, <br/>如果你也想参与到 3306π 活动中，请联系我们。</p>
